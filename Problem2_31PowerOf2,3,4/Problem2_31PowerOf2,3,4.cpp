// Problem2_31PowerOf2,3,4.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	cout << "The fourth power of " << number << " is " << number * number * number * number << endl;
	return 0;
}
